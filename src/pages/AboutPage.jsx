...
function AboutPage() {
    return (
        <>
            ...
            <div className="mb-30 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center gap-20 mt-6 px-5 md:px-20">
            ...
            <div className="mb-30 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center gap-4 px-5 md:px-20">
                <div className=" px-5 md:px-20 bg-[var(--lightblue)]">
                ...
                <div className=" md:w-1/3 flex justify-right mr-16">
                    <div className="w-[300px] h-[300px] md:w-[450px] md:h-auto gap-20 mt-10 py-10 px-5 md:px-20">
            ...
            <div className="mb-30 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center mt-6 gap-5 px-3 md:px-20">
                <div className=" md:w-1/2 flex justify-center">
                    <div className="w-[120px] h-[160px] md:w-[300px] md:h-auto ">
                        <img
            ...
            <div className="mb-30 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center gap-4 px-5 md:px-20">
                ...
                <div className=" md:w-1/3 flex justify-right mt-3">
                    <div className="w-[300px] h-[300px] md:w-[200px] md:h-auto ">
                        <img src="AboutPage/Building.png" alt="Kids enjoying ice pops" className="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
            <div className="mb-30 animate-appear flex justify-center items-center mt-15 mx-5 md:mx-20 px-5">
            ...
            <div className="mb-20 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center mt-6 gap-5 px-3 md:px-20">
                <div className=" md:w-1/3 flex justify-right mr-10">
                    <div className="w-[300px] h-[300px] md:w-[450px] md:h-[400px] gap-5 px-5 md:px-20">
            ...
            <div className="animate-appear mb-30 justify-center gap-6 mt-5">
            ...
            <div className="mb-0 md:mb-10 animate-appear flex flex-col md:flex-row items-center md:items-start justify-center mt-6 gap-5 px-3 md:px-20">
                <div className=" md:w-1/2 flex justify-center">
